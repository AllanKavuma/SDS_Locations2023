---
title: "Regional.Supervisor Site Allocations"
author: "ATC"
date: "03 Jan 2023"
...
## Read the data
## Read the site data
sitedata <- read.xlsx("New site distribution - 2023.xlsx", sheetName = "Sheet1")
...
```{r CircularPins, echo=FALSE, message=FALSE, warning=FALSE, fig.width=16, fig.height=12}
...
```{r CircularPinsIEng, echo=FALSE, message=FALSE, warning=FALSE, fig.width=16, fig.height=12}
#leaflet(siteLocations) %>% addTiles() %>% addMarkers(lat = siteLocations$Latitude, lng = siteLocations$Longitude) %>% addPopups(siteLocations$Site.name,siteLocations$Site.ID, options = popupOptions(closeButton = FALSE))
